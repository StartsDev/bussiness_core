...
exports.maintFilterOptions = void 0;
const Sequelize = require("sequelize");
const maintFilterOptions = (params) => {
    let optionsm = {};
    let optionse = {};
    let optionsl = {};
    let optionsh = {};
    let optionsc = {};
    const { status, businessName, nit, techName, address, email, city, contact, headName, addressh, emailh, locationName, name, serial, model, type, brand, } = params;
    // Maintenance
    if (status) {
        optionsm = {
